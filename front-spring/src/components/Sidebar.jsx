...
const handleLogout = () => {
  ...
  return (
   ...
   className='hs-overlay hs-overlay-open:translate-x-0 -translate-x-full transition-all duration-300 transform hidden fixed top-0 start-0 bottom-0 z-[60] w-72 bg-blue-300 border-e border-gray-200 pt-7 pb-10 overflow-y-auto lg:block lg:translate-x-0 lg:end-auto lg:bottom-0 [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-slate-700 dark:[&::-webkit-scrollbar-thumb]:bg-slate-500 dark:bg-gray-800 dark:border-gray-700'
>
        ...
        >
          <span class="flex flex-col items-center justify-center mb-5">
           ...
           {!loading && <>
            ...
            <p className="text-lg pt-2 text-gray-700 font-medium">  {prof.userName}</p>
           </>}
            <br/>
            <br/>
          </span>
  ...
  <button
    ...
    className='flex items-center gap-x-3.5 py-2 px-2.5 text-md text-red-500 rounded-lg hover:bg-gray-100 dark:bg-gray-900 dark:text-white dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600'
  >
